...
namespace meta {
    ...
    struct replace<truth::logic::Implies<first, rest...>, a, b> {
        using result = typename replace<truth::logic::implies<rest...>, a, b>::result::template prepend<typename replace<first, a, b>::result>&;
    };
    
    template <typename a, typename b, typename domain, typename range> 
    struct replace<truth::logic::Implies<domain, range>, a, b> {
        using result = truth::logic::Implies<
